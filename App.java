...
public class App {
            ...
            while (opt != 5) {
                ...
                if (opt == 1) {
                    ...
                    if (l != null) {
                        ...
                        if (sub == 1) { System.out.print("Novo Título: "); String nt = sc.nextLine(); 
                        ...
                        } else if (sub == 2) { System.out.print("Novo Preço: "); float np = sc.nextFloat();
                        ...
                        } else if (sub == 3) { System.out.print("Nova Data: "); 
    ...
    private static long convData(String d) {
        try { return new SimpleDateFormat("dd/MM/yyyy").parse(d).getTime(); }
